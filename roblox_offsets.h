/*
 * Roblox Version: version-b8771a24f36a4ef8
 * Updated from rbxoffsets.xyz dump
 */
...
// clang-format off
namespace offsets {
    inline constexpr const char* roblox_version = "version-b8771a24f36a4ef8";
    ...
    namespace FakeDataModel {
        inline constexpr uintptr_t Pointer       = 0x834A788;
        inline constexpr uintptr_t RealDataModel = 0x1C0;
    }

    namespace GuiBase2D {
        inline constexpr uintptr_t AbsolutePosition = 0x10C; /* updated from dump */
    ...
    namespace GuiObject {
        ...
        inline constexpr uintptr_t BackgroundTransparency = 0x56C; /* updated from dump */
    ...
    namespace Lighting {
        ...
        inline constexpr uintptr_t Atmosphere             = 0x1E8; /* updated from dump */
        inline constexpr uintptr_t Brightness             = 0x120; /* updated from dump */
        inline constexpr uintptr_t ClockTime              = 0x1B8;
        inline constexpr uintptr_t ColorShift_Bottom      = 0xE4; /* updated from dump */
        inline constexpr uintptr_t ColorShift_Top         = 0xF0; /* updated from dump */
    ...
    namespace MaterialColors {
        ...
        inline constexpr uintptr_t Concrete    = 0xC; /* added from dump */
    ...
    namespace Player {
        ...
        inline constexpr uintptr_t DisplayName          = 0x130; /* updated from dump */
        inline constexpr uintptr_t HealthDisplayDistance= 0x348;
        inline constexpr uintptr_t LocaleId             = 0x6C8;
        inline constexpr uintptr_t NameDisplayDistance  = 0x358; /* updated from dump */
    ...
    namespace Primitive {
        ...
        inline constexpr uintptr_t CFrame                  = 0xC0; /* updated from dump */
        inline constexpr uintptr_t Material                = 0x22E; /* updated from dump */
    ...
    namespace Sky {
        ...
        inline constexpr uintptr_t SunAngularSize   = 0x264; /* updated from dump */
    ...
    namespace Tool {
        inline constexpr uintptr_t CanBeDropped        = 0x4C0; /* updated from dump */
        inline constexpr uintptr_t Enabled             = 0x4C1; /* updated from dump */
        inline constexpr uintptr_t Grip                = 0x490; /* updated from dump */
        inline constexpr uintptr_t GripForward         = 0x4A8; /* updated from dump */
        inline constexpr uintptr_t GripPos             = 0x4B4; /* updated from dump */
        inline constexpr uintptr_t GripRight           = 0x490; /* updated from dump */
        inline constexpr uintptr_t GripUp              = 0x49C; /* updated from dump */
        inline constexpr uintptr_t ManualActivationOnly= 0x4C2; /* updated from dump */
        inline constexpr uintptr_t RequiresHandle      = 0x4C3; /* updated from dump */
        inline constexpr uintptr_t Tooltip             = 0x470; /* updated from dump */
    }
    ...
    namespace VisualEngine {
        ...
        inline constexpr uintptr_t FakeDataModel = 0xA40; /* updated from dump */
        inline constexpr uintptr_t Pointer       = 0x7EF80D8;
        inline constexpr uintptr_t RenderView    = 0xB40; /* updated from dump */
    ...
    /* ── Compatibility layer ───────────────────────────────────── */
    namespace Prim    = Primitive;
    namespace VEngine = VisualEngine;

    inline constexpr uintptr_t CameraInstance = Workspace::CurrentCamera;
